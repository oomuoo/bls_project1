...
<h2><?php echo $general->name; ?></h2>
		<br />
		<center><?php if($general->picture != null){?>
		<img  width="270" height="360"  src="/bls_project1/images/book_img/<?php echo $general->picture?>"></img>
		<?php }?></center>
		<br />
		<font color = "#0000ff">วันที่สร้าง : <?php echo $general->create_date; ?> </font>
		<br />
		<?php echo $IdBook = $general->id ; ?>
		<font color = "#0000ff">นามปากกา: <?php //echo $IdBook = $healthAndBeauty->alias ; ?> </font>
		<br />
		<br />
		รายละเอียด: <?php echo $general['description']; ?> </center>
		<br />
		<br />
	...
	'url'=>'index.php?r=bookshelf/index&id='.$general->id,
	)); ?>
    </div>
...
if ($connect->query($query) === TRUE) {
	...
	$redirectUrl = '/bls_project1/index.php?r=/general/view&id='.$general->id;	
