...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, category_id, status', 'required'),
			array('category_id, member_id, score_id, type_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>45),
			array('status', 'length', 'max'=>1),
			array('description', 'file', 'types'=>'docx', 'allowEmpty' => true),
	...
	public function relations()
	{
		...
		return array(
			...
			//'bookshelf' => array(self::BELONGS_TO, 'Bookshelf', 'bookshelf_id'),
		);
	}
	...
	public function searchNewBooks()
	{
		// @todo Please modify the following code to remove attributes that should not be searched.
