	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				initOpacity: 1,
				imgPath: assetUrl+'/images/',
				langPath: assetUrl+'/js/',
				extPath: assetUrl+'/extensions/',
				jGraduatePath: assetUrl+'/images/',
			...
			*/
			...
			var clickExport = function() {
				...
				if(window.canvg) {
					...
					$.getScript(assetUrl+'/js/rgbcolor.js', function() {
						$.getScript(assetUrl+'/js/canvg.js', function() {
							svgCanvas.rasterExport();
						});
					});
				}
